...
const WEBHOOK_URL = 'https://servicios-n8n-n8n.9barxf.easypanel.host/webhook/consulta-ventas-v3';
...
const ChatBot = () => {
  ...
  cleaned = cleaned.replace(/Optimus/gi, 'Óp-ti-mus');
        ...
        <Stack direction="row" justifyContent="space-between" alignItems="center">
          ...
          <Stack direction="row" spacing={1}>
            <Tooltip title="Subir Excel">
              <IconButton color="primary" onClick={() => setModalAbierto(true)}><UploadFileIcon /></IconButton>
            </Tooltip>
